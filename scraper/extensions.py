...
# adding the package would not work, hence the direct import
# (not compatible with new scrapy version...)
import logging
...
class WebService(Site):
    def __init__(self, crawler):
        ...
        self.host = crawler.settings.get("PROMETHEUS_HOST", "0.0.0.0")  # nosec
